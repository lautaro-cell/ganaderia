...
namespace App.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260429141009_AddPasswordResetAndSuperAdmin")]
    partial class AddPasswordResetAndSuperAdmin
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("App.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<Instant?>("PasswordResetTokenExpiry")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("App.Domain.Entities.ActivityAnimalCategory", b =>
                {
                    b.HasOne("App.Domain.Entities.Activity", "Activity")
                        .WithMany("ActivityAnimalCategories")
                        .HasForeignKey("ActivityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("App.Domain.Entities.EventTemplateActivity", b =>
                {
                    ...
                    b.HasOne("App.Domain.Entities.EventTemplate", "EventTemplate")
                        .WithMany("EventTemplateActivities")
            ...
            modelBuilder.Entity("App.Domain.Entities.Activity", b =>
                {
                    b.Navigation("ActivityAnimalCategories");
            ...
            modelBuilder.Entity("App.Domain.Entities.EventTemplate", b =>
                {
                    b.Navigation("EventTemplateActivities");
                });
