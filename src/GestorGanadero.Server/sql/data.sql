...
VALUES 
('b1111111-1111-1111-1111-111111111111','Lote A (Los Pinos)','11111111-1111-1111-1111-111111111111','f1111111-1111-1111-1111-111111111111',now()),
('b1111111-1111-1111-1111-111111111112','Lote B (Bañadero)','11111111-1111-1111-1111-111111111111','f1111111-1111-1111-1111-111111111111',now());
...
INSERT INTO "Lotes" ("Id","Name","TenantId","FieldId","CreatedAt")
VALUES 
('b2222222-2222-2222-2222-222222222221','Corrales Premium','22222222-2222-2222-2222-222222222222','f2222222-2222-2222-2222-222222222221',now());
...
('a1111111-1111-1111-1111-111111111112','b1111111-1111-1111-1111-111111111112'),
('a2222222-2222-2222-2222-222222222221','b2222222-2222-2222-2222-222222222221'),
('a3333333-3333-3333-3333-333333333331','b2222222-2222-2222-2222-222222222221');
...
VALUES
-- El Ombú
('c1111111-1111-1111-1111-111111111111','Ternero','a1111111-1111-1111-1111-111111111111','11111111-1111-1111-1111-111111111111',160,true,1,now()),
('c1111111-1111-1111-1111-111111111112','Vaca con Cría','a1111111-1111-1111-1111-111111111111','11111111-1111-1111-1111-111111111111',450,true,1,now()),
('c1111111-1111-1111-1111-111111111113','Novillo Recría','a1111111-1111-1111-1111-111111111112','11111111-1111-1111-1111-111111111111',320,true,1,now()),
-- San Marcos
('c2222222-2222-2222-2222-222222222221','Toro Puro de Pedigree','a2222222-2222-2222-2222-222222222221','22222222-2222-2222-2222-222222222222',850,true,1,now()),
('c2222222-2222-2222-2222-222222222222','Vaquillona Elite','a2222222-2222-2222-2222-222222222221','22222222-2222-2222-2222-222222222222',400,true,1,now());
...
VALUES
(gen_random_uuid(),'11111111-1111-1111-1111-111111111111','e1111111-1111-1111-1111-111111111111','CC-OMBU-01','f1111111-1111-1111-1111-111111111111','b1111111-1111-1111-1111-111111111111','a1111111-1111-1111-1111-111111111111','c1111111-1111-1111-1111-111111111111',50,8000,160,5000000,now() - interval '3 months',3,now()),
(gen_random_uuid(),'11111111-1111-1111-1111-111111111111','e1111111-1111-1111-1111-111111111111','CC-OMBU-01','f1111111-1111-1111-1111-111111111111','b1111111-1111-1111-1111-111111111111','a1111111-1111-1111-1111-111111111111','c1111111-1111-1111-1111-111111111111',45,7200,160,4500000,now() - interval '2 months',3,now()),
(gen_random_uuid(),'11111111-1111-1111-1111-111111111111','e1111111-1111-1111-1111-111111111112','CC-OMBU-01','f1111111-1111-1111-1111-111111111111','b1111111-1111-1111-1111-111111111111','a1111111-1111-1111-1111-111111111111','c1111111-1111-1111-1111-111111111111',95,19000,200,0,now() - interval '1 week',0,now()),
-- Otro lote de El Ombú
(gen_random_uuid(),'11111111-1111-1111-1111-111111111111','e1111111-1111-1111-1111-111111111112','CC-OMBU-02','f1111111-1111-1111-1111-111111111112','b1111111-1111-1111-1111-111111111112','a1111111-1111-1111-1111-111111111112','c1111111-1111-1111-1111-111111111113',120,42000,350,0,now() - interval '1 month',1,now());

-- Tenant 2: San Marcos
INSERT INTO "LivestockEvents" ("Id","TenantId","EventTemplateId","CostCenterCode","FieldId","LoteId","ActivityId","CategoryId","HeadCount","EstimatedWeightKg","WeightPerHead","TotalAmount","EventDate","Status","CreatedAt")
VALUES
(gen_random_uuid(),'22222222-2222-2222-2222-222222222222','e2222222-2222-2222-2222-222222222221','CC-GEN-01','f2222222-2222-2222-2222-222222222221','b2222222-2222-2222-2222-222222222221','a2222222-2222-2222-2222-222222222221','c2222222-2222-2222-2222-222222222222',15,0,0,150000,now() - interval '15 days',1,now());
